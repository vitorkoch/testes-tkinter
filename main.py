...
calculator_button = tk.Button(menu, text='Calculator', command=calc_window, width=15)
calculator_button.pack(pady=1)

features_button = tk.Button(menu, text='Fun Features', command=feature_window, width=15)
